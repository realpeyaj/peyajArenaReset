...
/**
 * This Class handles the 'par_tool' command.
 * @author peyaj
 **/
public class ToolCmd extends AbstractCommandExecutor implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(!sender.hasPermission("peyajarenareset.tool")) {
    ...
    protected class SetPosTool extends ToolCmd {
        ...
        private final NamespacedKey setPosToolKey = new NamespacedKey(super.getPlugin(), "peyajArenaReset_PosTool");
